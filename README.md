...
[Download MYCAM v2.25.6](https://github.com/elementtime6969/mycam/releases/latest/download/Mycam-v2.25.6.apk)
...
| Version | `2.25.6` |
| Version code | `64` |
| APK file | `Mycam-v2.25.6.apk` release asset |
| APK size | `151,544,393` bytes |
